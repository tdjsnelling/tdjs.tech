    ...
    return (
      <React.Fragment>
        <Helmet>
          ...
          <meta name="description" content="Full-stack JavaScript developer from the UK. Placement front-end developer for Clock. Computer science at Loughborough University." />
          <meta property="og:description" content="Full-stack JavaScript developer from the UK. Placement front-end developer for Clock. Computer science at Loughborough University." />
